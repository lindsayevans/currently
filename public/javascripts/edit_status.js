...
function build_status_type_fields(status_type){
  return status_type['input_template'].replace(/\{([a-z0-9]+)\}/gi, '<input type="text" name="status[status_attributes_attributes][$1]" id="status_status_attributes_attributes_$1" />');
}
